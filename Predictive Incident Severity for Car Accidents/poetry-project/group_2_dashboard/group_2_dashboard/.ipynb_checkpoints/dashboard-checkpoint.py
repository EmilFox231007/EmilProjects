...
def heatmap_page():
    ...
    plot_heatmap(df_safe_driving_subset, 'HARSH CORNERING', 'Heatmap of Harsh Cornering Incidents')
    ...
    plot_heatmap(df_safe_driving_subset, 'SPEED', 'Heatmap of Speed Incidents')
    ...
    plot_heatmap(df_safe_driving_subset, 'BRAKING', 'Heatmap of Braking Incidents')
    ...
    plot_heatmap(df_safe_driving_subset, 'ACCELERATING', 'Heatmap of Accelerating Incidents')



# Custom CSS to make the select box fully white with black text
st.markdown("""
    <style>
    ...
    .stSelectbox div[data-baseweb="select"] .css-26l3qy-menu {
        background-color: white;
    }
    .stSelectbox div[data-baseweb="select"] .css-4ljt47-MenuList {
        background-color: white;
        color: black;
    }
    </style>
...
# Optional: Display the selected page
